...
- [[obsidian-basetag|Base Tag Renderer]]: This plugin renders the basename of tags in preview mode.
...
- [[obsidian-gpt|GPT]]: GPT & Large Language Model completions in Obsidian editor via API
...
- [[insert-unsplash-image|Image Inserter]]: This plugin helps users easily search and insert images to editors from Unsplash / Pixabay.
...
- [[khoj|Khoj]]: Natural, Incremental Search for your Second Brain 🦅
...
- [[sync-graph-settings|Sync Graph Settings]]: This is a plugin for syncing graph settings (like Color Groups) to Local Graphs
...
- [[obsidian-transcription|Transcription]]: Obsidian plugin to create high-quality transcriptions from markdown linked audio files
...
- [[webpage-html-export|Webpage HTML Export]]: Exports an obsidian document as an HTML document / webpage / website (correctly!). Also has interactive embedded dark / light theme toggle, and document outline.
